...
def graph_data(stock):
    ...
    # Annotation example
    # params: text, arrow_to loaction, text location, (0, 0 lower left, 1, 1
    # upper right)
    ax1.annotate('Bad news', (date[300], highp[300]), xytext=(0.2, 0.8),
            textcoords='axes fraction', arrowprops=dict(facecolor='r', 
                color='grey'))

    # Font dict and text example
    font_dict = {'family': 'serif', 'color': 'darkred', 'size': 15}
    ax1.text(date[300], closep[1], 'Text Example', fontdict=font_dict)
